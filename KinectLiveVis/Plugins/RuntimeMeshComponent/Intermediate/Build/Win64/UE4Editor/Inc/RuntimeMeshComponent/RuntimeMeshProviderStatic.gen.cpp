...
// End Cross Module References
	...
	struct Z_Construct_UFunction_URuntimeMeshProviderStatic_SetShouldSerializeMeshData_Statics
	{
		...
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bIsSerialized;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_URuntimeMeshProviderStatic_SetShouldSerializeMeshData_Statics::NewProp_bIsSerialized = { "bIsSerialized", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(RuntimeMeshProviderStatic_eventSetShouldSerializeMeshData_Parms), &Z_Construct_UFunction_URuntimeMeshProviderStatic_SetShouldSerializeMeshData_Statics::NewProp_bIsSerialized_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_URuntimeMeshProviderStatic_SetShouldSerializeMeshData_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_URuntimeMeshProviderStatic_SetShouldSerializeMeshData_Statics::NewProp_bIsSerialized,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_URuntimeMeshProviderStatic_SetShouldSerializeMeshData_Statics::Function_MetaDataParams[] = {
		{ "Category", "RuntimeMesh|Providers|Static" },
		{ "ModuleRelativePath", "Public/Providers/RuntimeMeshProviderStatic.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_URuntimeMeshProviderStatic_SetShouldSerializeMeshData_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_URuntimeMeshProviderStatic, nullptr, "SetShouldSerializeMeshData", nullptr, nullptr, sizeof(RuntimeMeshProviderStatic_eventSetShouldSerializeMeshData_Parms), Z_Construct_UFunction_URuntimeMeshProviderStatic_SetShouldSerializeMeshData_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_URuntimeMeshProviderStatic_SetShouldSerializeMeshData_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_URuntimeMeshProviderStatic_SetShouldSerializeMeshData_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_URuntimeMeshProviderStatic_SetShouldSerializeMeshData_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_URuntimeMeshProviderStatic_SetShouldSerializeMeshData()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_URuntimeMeshProviderStatic_SetShouldSerializeMeshData_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_URuntimeMeshProviderStatic_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_URuntimeMeshProviderStatic_SetShouldSerializeMeshData, "SetShouldSerializeMeshData" }, // 1258351430
	...
	IMPLEMENT_CLASS(URuntimeMeshProviderStatic, 3268516108);
