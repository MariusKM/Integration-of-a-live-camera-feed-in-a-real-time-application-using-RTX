...
class UScriptStruct* FRuntimeMeshDistanceFieldData::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern RUNTIMEMESHCOMPONENT_API uint32 Get_Z_Construct_UScriptStruct_FRuntimeMeshDistanceFieldData_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FRuntimeMeshDistanceFieldData, Z_Construct_UPackage__Script_RuntimeMeshComponent(), TEXT("RuntimeMeshDistanceFieldData"), sizeof(FRuntimeMeshDistanceFieldData), Get_Z_Construct_UScriptStruct_FRuntimeMeshDistanceFieldData_Hash());
	}
	return Singleton;
}
...
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FRuntimeMeshDistanceFieldData(FRuntimeMeshDistanceFieldData::StaticStruct, TEXT("/Script/RuntimeMeshComponent"), TEXT("RuntimeMeshDistanceFieldData"), false, nullptr, nullptr);
static struct FScriptStruct_RuntimeMeshComponent_StaticRegisterNativesFRuntimeMeshDistanceFieldData
{
	FScriptStruct_RuntimeMeshComponent_StaticRegisterNativesFRuntimeMeshDistanceFieldData()
	{
		UScriptStruct::DeferCppStructOps<FRuntimeMeshDistanceFieldData>(FName(TEXT("RuntimeMeshDistanceFieldData")));
	}
} ScriptStruct_RuntimeMeshComponent_StaticRegisterNativesFRuntimeMeshDistanceFieldData;
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FRuntimeMeshDistanceFieldData_Statics::Struct_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/RuntimeMeshCore.h" },
	};
#endif
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FRuntimeMeshDistanceFieldData_Statics::ReturnStructParams = {
		(UObject* (*)())Z_Construct_UPackage__Script_RuntimeMeshComponent,
		nullptr,
		&NewStructOps,
	...
	{
#if WITH_HOT_RELOAD
		extern uint32 Get_Z_Construct_UScriptStruct_FRuntimeMeshDistanceFieldData_Hash();
		UPackage* Outer = Z_Construct_UPackage__Script_RuntimeMeshComponent();
		static UScriptStruct* ReturnStruct = FindExistingStructIfHotReloadOrDynamic(Outer, TEXT("RuntimeMeshDistanceFieldData"), sizeof(FRuntimeMeshDistanceFieldData), Get_Z_Construct_UScriptStruct_FRuntimeMeshDistanceFieldData_Hash(), false);
#else
		static UScriptStruct* ReturnStruct = nullptr;
#endif
		if (!ReturnStruct)
		{
			UE4CodeGen_Private::ConstructUScriptStruct(ReturnStruct, Z_Construct_UScriptStruct_FRuntimeMeshDistanceFieldData_Statics::ReturnStructParams);
		}
		return ReturnStruct;
	}
	uint32 Get_Z_Construct_UScriptStruct_FRuntimeMeshDistanceFieldData_Hash() { return 2545772271U; }
...
static struct FScriptStruct_RuntimeMeshComponent_StaticRegisterNativesFRuntimeMeshTangent
{
	...
	{
		UScriptStruct::DeferCppStructOps<FRuntimeMeshTangent>(FName(TEXT("RuntimeMeshTangent")));
	}
